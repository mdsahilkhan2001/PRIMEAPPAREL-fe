                        ...
                        <div className="mt-8 flex flex-col gap-3">
                            <div className="flex flex-col sm:flex-row gap-3">
                                <button
                                    ...
                                    className="flex-1 btn btn-outline border-2 border-accent text-accent hover:bg-accent hover:text-white py-3.5 cursor-pointer rounded-xl font-bold text-base flex items-center justify-center gap-2 transition-all hover:shadow-lg"
                                >
                                ...
                                <button
                                    ...
                                    className="flex-[2] btn btn-accent py-3.5 cursor-pointer rounded-xl font-bold text-base flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:shadow-accent/30 transition-all"
                                >
                            ...
                            <button
                                ...
                                className="w-full btn bg-gray-900 text-white py-3.5 rounded-xl font-bold text-base flex items-center justify-center gap-2 cursor-pointer shadow-lg hover:bg-gray-800 hover:shadow-xl transition-all"
                            >
