...
const Newsletter = () => (
  <section className="py-24 bg-accent text-white relative overflow-hidden">
    ...
    <div className="container-custom relative z-10 text-center">
      ...
      <div className="max-w-md mx-auto flex flex-col md:flex-row gap-4 md:gap-2 p-4 md:p-2 bg-white/10 backdrop-blur-md rounded-2xl md:rounded-full border border-white/20">
        <input
          type="email"
          placeholder="Enter your email address"
          className="w-full md:flex-1 bg-transparent border-b md:border-none border-white/30 text-white placeholder-white/60 focus:ring-0 outline-none px-4 py-3 md:py-2 text-center md:text-left"
        />
        <button className="w-full md:w-auto bg-white text-accent px-8 py-3 rounded-xl md:rounded-full font-bold uppercase text-sm tracking-wider hover:bg-slate-100 transition-colors cursor-pointer shadow-lg md:shadow-none">
          Subscribe
        </button>
      </div>
    </div>
